...
public class Loadmessagesadapter extends ArrayAdapter {
    Context c;
    ArrayList<LoadMessages> list;
    public Loadmessagesadapter( Context context, ArrayList<LoadMessages> ar) {
    ...
    public View getView(int position,  View convertView, ViewGroup parent) {
        ...
        LoadMessages loadMessages = list.get(position);
