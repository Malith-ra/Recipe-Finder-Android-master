...
public class EditCard extends ListActivity {

    private static final String[] SELECT = {CARD_NAME};
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent intent = new Intent(EditCard.this, CardDetails.class);
        intent.putExtra("card.name", productName);
