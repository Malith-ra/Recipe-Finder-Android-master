...
public class LoadBlocklistAdapter extends ArrayAdapter {

    Context c;
    ArrayList<LoadBlockNumbers> list;
    public LoadBlocklistAdapter(@NonNull Context context, ArrayList<LoadBlockNumbers> ar) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        LoadBlockNumbers loadnumberzlists = list.get(position);
