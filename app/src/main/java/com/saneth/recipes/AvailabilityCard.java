...
public class AvailabilityCard extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_availability_card);
    ...
    private ArrayList<String> getAvailableProductNames() {
        ...
        Cursor cursor = db.rawQuery("SELECT "+CARD_NAME+", "+AVAILABILITY+" FROM "+TABLE_NAME+" WHERE availability1='Available'", null);
