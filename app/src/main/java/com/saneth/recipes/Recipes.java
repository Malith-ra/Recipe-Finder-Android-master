    ...
    public void onClick(View v) {
        switch (v.getId()){
            case  R.id.register_btn:
                Intent intent1 = new Intent(Recipes.this,RegisterCard.class);
                startActivity(intent1);
                break;
            case  R.id.display_btn:
                Intent intent2 = new Intent(Recipes.this, DisplayCard.class);
                startActivity(intent2);
                break;
            case  R.id.availability_btn:
                Intent intent3 = new Intent(Recipes.this,AvailabilityCard.class);
                startActivity(intent3);
                break;
            case  R.id.edit_btn:
                Intent intent4 = new Intent(Recipes.this,EditCard.class);
                startActivity(intent4);
                break;
            case  R.id.search_btn:
                Intent intent5 = new Intent(Recipes.this,SearchCard.class);
